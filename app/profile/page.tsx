...
export default function ProfilePage() {
    ...
    useEffect(() => {
        async function load() {
            ...
            if (playerRes.error) {
                setError("Профайлын мэдээлэл ачаалахад алдаа гарлаа.");
                setLoading(false);
                return;
            }
    ...
    if (error || !data) {
        return (
            <div className="flex min-h-[80vh] items-center justify-center px-4">
                <div className="text-center">
                    <p className="text-red-400 mb-4">{error ?? "Алдаа гарлаа."}</p>
    ...
    const sceneLabels: Record<string, string> = {
        Yurt: "Юрт — Гэр",
        VerdantPlains: "Ногоон тал (Дэлхий 1)",
        FracturedPlains: "Хагарсан тал (Дэлхий 2)",
    };
    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-12">
            ...
            <div className="mb-10 text-center">
                ...
                <p className="text-sm text-[#6b5a8a]">Адал явдал эхэлсэн: {joinDate}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 sm:grid-cols-4">
                ...
                />
                <StatCard
                    label="Одоогийн ертөнц"
                    value={save?.current_scene ?? "—"}
                    accent="gold"
                />
                <StatCard
                    label="Ажиглагч"
                    value={bossDefeated ? "Ялагдсан" : "Хүлээж байна"}
            ...
            <div className="mb-6 rounded-xl border border-[#2a1a4a] bg-[#120820] p-6">
                ...
                <div className="w-full h-3 rounded-full bg-[#1a0a2e] overflow-hidden">
                    <div
                        className="h-full rounded-full bg-gradient-to-r from-[#00d4b1] to-[#00a88e]"
                ...
                <p className="mt-2 text-xs text-[#4a3a6a]">
                    {harmonyPct < 25
                        ? "Харанхуй хөдөлж эхэлж байна. Таны аялал дөнгөж эхэлж байна."
                        : harmonyPct < 50
                            ? "Эв зохицол нэмэгдэж байна. Ертөнц таныг мэдэрч байна."
                            : harmonyPct < 75
                                ? "Чичирхийлэл хүчтэй болж байна. Ажиглагч таныг анзаарч эхэллээ."
                                : harmonyPct < 100
                                    ? "Бараг төгс эв зохицол. Харанхуй чичирч байна."
                                    : "Төгс эв зохицол. Та Харанхуйн нэг хэсэг болсон."}
                </p>
            </div>
            ...
            {save && (
                <div className="mb-6 rounded-xl border border-[#2a1a4a] bg-[#120820] p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                        <DetailRow label="Байршил" value={currentScene} />
                        <DetailRow
                            label="Албан байрлал"
                        ...
                        <DetailRow
                            label="Зэвсэг"
                            value={save.equipped_weapon ?? "Байхгүй"}
                        />
                        <DetailRow
                            label="Сүүлд хадгалсан"
                ...
                <div className="mb-6 rounded-xl border border-[#2a1a4a] bg-[#120820] p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {ownedWeapons.map((weapon) => (
                            <span
                                key={weapon}
                                className={`rounded-full border px-3 py-1 text-xs font-medium ${weapon === save?.equipped_weapon
